package com.example.priyasindkar.videodemo;

/**
 * Created by priyasindkar on 08-02-2016.
 */
...
public class VideoSliceSeekBar extends ImageView {
    ...
    //params
    private Bitmap thumbSlice = BitmapFactory.decodeResource(getResources(), R.drawable.ic_av_skip_previous);
    private Bitmap thumbCurrentVideoPosition = BitmapFactory.decodeResource(getResources(), R.drawable.ic_av_skip_next);
    ...
    private int thumbPadding = getResources().getDimensionPixelOffset(R.dimen.activity_horizontal_margin);
